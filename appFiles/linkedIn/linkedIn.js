                    ...
                    <div class="profile-view-left-container">
                        <div class="inner-profileView-Box">
                            <div class="inner-profileView-Banner">
                                ...
                                <img  class="prfile-mypic" src="appFiles/linkedIn/image/bigMe.jpg" alt="profile">
                            </div>
                            <div class="inner-profileView-content">
                                ...
                                <div class="inner-profileView-content-bioText">
                                    Immersive Tech Lead @ TCS Rapid Labs, TCS Research and Innovation 
                                </div>
                                <div class="inner-profileView-content-address">
                                    Ernakulam, Kerala, India . <span><a href="mailto:mail.vishnu.sivan@gmail.com">Contact info</a></span>
                                </div>
                    ...
                    <div class="profile-view-right-container">
                        ...
                        <div class="people-viewed-container">
                            ...
                            <div class="people-info-box">
                                <img src="appFiles/linkedIn/image/hema.png" alt="loki">
                            ...
                            <div class="people-info-box">
                                <img src="appFiles/linkedIn/image/jinson.png" alt="ScarletWitch">
                                <div class="userData-Box">
                                        <div class="userData-Box-Name">
                                            Jinson K J
                                        </div>
                            ...
                            <div class="people-info-box">
                                <img src="appFiles/linkedIn/image/anandu.png" alt="thor">
                                <div class="userData-Box">
                                        <div class="userData-Box-Name">
                                            Anandu Sugathan
                                        </div>
                                        <div class="userData-Box-Bio">
                                            UXD at Tata Consultancy Services
                                        </div>
                                        <div class="userData-Box-messageBox">
                                        Message
                                        </div>
                            ...
                            <div class="people-info-box">
                                <img src="appFiles/linkedIn/image/aswin.png" alt="bruce">
                                <div class="userData-Box">
                                        <div class="userData-Box-Name">
                                            Aswin R. S.
                                        </div>
                                        <div class="userData-Box-Bio">
                                            AI Developer| React Developer| Rapid Labs 
                                        </div>
                                        <div class="userData-Box-messageBox">
                                        Message
                                        </div>
                            ...
                            <div class="people-info-box">
                                <img src="appFiles/linkedIn/image/navaneeth.png" alt="blackWido">
                                <div class="userData-Box">
                                        <div class="userData-Box-Name">
                                            Navaneeth K
                                        </div>
                                        <div class="userData-Box-Bio">
                                            System Engineer @ TCS Rapid Labs
                                        </div>
                                        <div class="userData-Box-messageBox">
                                        Message
                                        </div>
